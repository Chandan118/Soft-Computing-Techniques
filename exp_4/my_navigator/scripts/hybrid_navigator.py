...
class HybridNavigator:
    def __init__(self):
        ...
        rospy.loginfo("Hybrid Navigator initialized. Waiting for goal from RViz...")
    ...
    def rviz_goal_callback(self, msg):
        ...
        if self.mux_select:
            try:
                self.mux_select()
                rospy.loginfo("Switched velocity control to hybrid navigator")
...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo("Hybrid navigator shut down.")